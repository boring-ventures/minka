  ...
  if (state.isSubmitting) {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <LoadingSpinner size="lg" showText text="Publicando campaña..." />
      </div>
    );
  }
    ...
    <div className="space-y-16">
      ...
      <Dialog open={previewOpen} onOpenChange={setPreviewOpen}>
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-[#2c6e49]">
              Vista previa de la campaña
            </DialogTitle>
            <DialogDescription>
              Así se verá tu campaña cuando sea publicada
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="mt-4 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="border rounded-lg p-4">
                ...
                <p className="font-medium">{formatCategory(state.category)}</p>
              </div>
              <div className="border rounded-lg p-4">
