      ...
      try {
        ...
        const namedDonors: LatestDonor[] = Array.isArray(
          ...
          ? data.data.map((donation: any) => ({
              id: donation.id,
              name:
                donation.donor?.name || 'Aportante anónimo',
        ...
        content={
          <div className='space-y-4'>
            ...
            <p>
              ...
              aportantes cuando una campaña indica que los fondos serán recibidos
