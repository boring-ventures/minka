...
export const faqCategories: FaqCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'Minka es una plataforma digital accesible desde cualquier parte del mundo. Las personas pueden realizar aportes desde Bolivia o desde el extranjero. Actualmente, los fondos recaudados pueden transferirse únicamente a cuentas bancarias bolivianas registradas y verificadas en la plataforma.',
      },
      {
        id: 'general-5',
        question: '¿Por qué confiar en Minka?',
        answer:
          'Minka implementa mecanismos de autenticación de usuarios, verificación de campañas, monitoreo permanente y sistemas seguros de pago. Además, promovemos la transparencia mediante procesos de revisión documental y actualizaciones periódicas de las campañas, permitiendo que los aportantes tomen decisiones informadas.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'Son empresas, asociaciones, instituciones, fundaciones u otras entidades legalmente reconocidas que pueden registrarse en la base de datos de Minka para generar mayor confianza sobre el destino de los aportes. Esto es especialmente importante para aportantes internacionales, que suelen necesitar más señales de seguridad antes de apoyar una campaña.\n\nTe recomendamos hacerlo porque mejora la visibilidad, la creación de campañas y la confianza de los aportantes.\n\nPara solicitarlo, envíanos un mensaje a info@minka-comunidad.org con: datos legales, número de registro, forma legal, NIT, cuenta bancaria, ubicación, información de contacto, sitio web, redes sociales y cualquier otro dato que quieran compartir con nosotros.\n\nEstos datos no son públicos; se usan únicamente para nuestra administración y para poder responder con mayor seguridad cuando un aportante tenga dudas.',
      },
      {
        id: 'campaign-6',
        question: '¿Qué es la verificación de campañas?',
        answer:
          'La verificación es un proceso mediante el cual el equipo de Minka revisa la documentación presentada por el organizador de una campaña para validar que la información proporcionada sea consistente con la causa publicada.\n\nDocumentos que se pueden presentar dependen del tipo de causa, pueden ser diagnóstico médico, receta farmacéutica, invitación a un torneo, factura de gastos realizados, presupuestos, etc.\n\nLas campañas verificadas cuentan con un distintivo visible dentro de la plataforma que ayuda a generar mayor confianza entre los aportantes.',
      },
      {
        id: 'campaign-7',
    ...
    items: [
      {
        ...
        answer:
          'La verificación ayuda a aumentar la transparencia y la confianza de los aportantes, permitiéndoles contar con información adicional sobre la causa que desean apoyar.',
      },
      {
        id: 'security-2',
        question:
