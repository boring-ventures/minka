...
export function ContactSection() {
  return (
    <div className="mt-16">
      <h2 className="text-2xl font-bold text-[#2c6e49] mb-8">Atención al cliente</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <MessageCircle className="h-5 w-5 text-[#2c6e49]" />
        ...
        >
          ...
          <span className="text-gray-600">Escríbenos por correo electrónico</span>
        </a>
