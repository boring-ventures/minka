...
const communityVoices = [
  {
    id: 1,
    quote:
      "Como aportante, quiero entender bien quién organiza la campaña, cuál es la necesidad y cómo se usará mi aporte antes de ayudar.",
    title: "Aportante anónimo",
  },
  {
    id: 2,
    quote:
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <p className="mt-5 text-lg leading-8 text-[#555555] md:text-xl">
            ...
            para aportantes, organizadores e instituciones.
          </p>
        </div>
