...
export function CampaignCard({
  ...
  return (
    <Link
      ...
      className="block h-full hover:shadow-md transition-all duration-200"
    >
      <div className="rounded-lg overflow-hidden bg-white border border-gray-100 h-[450px] grid grid-rows-[160px_1fr_auto]">
        ...
        <div className="p-4 overflow-hidden">
          ...
          <div className="mb-2 flex justify-between text-sm">
            ...
            <span className="font-medium">
              Bs. {raisedAmount.toLocaleString()} de{" "}
